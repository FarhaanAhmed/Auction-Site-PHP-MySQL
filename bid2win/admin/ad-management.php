                                ...
                                <div class="col-lg-offset-2 col-lg-8 col-lg-offset-2 reg-form">
                                    ...
                                    <form role="form" method="post" action="<?php if(isset($_GET['id'])) {echo "updateads.php?id=$aid";} else {echo "insertads.php";} ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><textarea class="textarea" placeholder="Enter text ..." name="adesc" required style="width: 100%;height:200px"><?php echo $adesc; ?></textarea></div>
                                        </div>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><input class="form-control" type="number" name="aqty" required value="<?php echo $aqty; ?>"></div>
                                        </div>
									<div class="form-group row">
                                            <label class="col-sm-3">Publish</label>
                                            <div class="col-sm-9"><input checked class="" type="checkbox" name="astatus"></div>
                                        </div>
...
<script>
						...
						jQuery(document).ready(function(){
							...
							jQuery("#acat").change(function(){
								jQuery.post("../member/getsubcat.php",
								{
