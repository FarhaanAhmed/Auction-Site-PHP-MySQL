                                    ...
                                    <form role="form" method="post">
										...
										<div class="form-group row">
										 ...
										 <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><button type="submit" class="btn btn-default btn-submit" name="sub">Change</button>
                                        </div>
...
if (isset($_POST['sub']))
{
	...
	$pass=$_POST['ops'];
	$newpass=$_POST['nps'];
	$query = mysql_query("select * from tbllogin where susername='$username' and spassword='$pass'");

	if (mysql_num_rows($query))
	{
	$update=mysql_query("update tbllogin set spassword='$newpass' where susername='$username'");
	if ($update)
	{
	...
	{
	die ("<script>alert('Error Occurred . Try later  !!')</script>");
	}
	}
	else
	{
