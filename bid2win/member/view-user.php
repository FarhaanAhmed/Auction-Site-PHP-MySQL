						...
						<table id="example" class="table table-striped table-bordered table-hover manag-table" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td>Farhaan Ahmed</td>
									<td>test@test.com</td>
									<td>Farhaan@123456</td>
									<td><button type="submit" class="btn btn-default btn-submit"><i class="fa fa-pencil"></i> Edit</button> 
									<a href="#" class="btn btn-view"><i class="fa fa-trash-o"></i>  Delete</a>
									<a href="#" class="btn btn-suspend"><i class="fa fa-dot-circle-o"></i>  Suspend</a></td>
								</tr>
